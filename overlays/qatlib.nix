  ...
  qatlib = super.stdenv.mkDerivation {
    ...
    preInstall = ''
      substituteInPlace Makefile \
        --replace 'install-systemdsystemunitDATA' ""
    '';
...
in {
  qatlib = super.stdenv.mkDerivation {
    ...
    preInstall = ''
      substituteInPlace quickassist/utilities/service/Makefile \
        --replace 'install-systemdsystemunitDATA' ""
    '';
...
in {
  qatlib = super.stdenv.mkDerivation {
    ...
    preConfigure = ''
      ./autogen.sh
      substituteInPlace quickassist/utilities/service/Makefile.am \
        --replace 'install-systemdsystemunitDATA' ""
    '';
